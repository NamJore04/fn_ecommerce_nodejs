        ...
        <Row>
          <Col md={4} className="mb-4">
            ...
            <div className="d-flex gap-3">
              <a href="https://www.facebook.com/nam.huynh.224968" target="_blank" rel="noopener noreferrer" className="text-light"><FaFacebook size={20} /></a>
              <a href="https://x.com/HunhHoiNam12832" target="_blank" rel="noopener noreferrer" className="text-light"><FaXTwitter size={20} /></a>
              <a href="https://www.instagram.com/namhuynhzz/" target="_blank" rel="noopener noreferrer" className="text-light"><FaInstagram size={20} /></a>
              <a href="https://www.linkedin.com/in/jore-nam-943a02236/" target="_blank" rel="noopener noreferrer" className="text-light"><FaLinkedin size={20} /></a>
            </div>
          </Col>
