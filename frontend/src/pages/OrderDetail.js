...
import { FaArrowLeft, FaTruck, FaCheckCircle, FaClock, FaMapMarkerAlt, FaCreditCard, FaBox, FaTimesCircle } from 'react-icons/fa';
              ...
              <Card className="mb-4">
                ...
                <Card.Body>
                  ...
                  {order.statusHistory && Array.isArray(order.statusHistory) && order.statusHistory.length > 0 && (
                    <div>
                      <h6>Status History <small className="text-muted">(newest first)</small></h6>
                      <div className="timeline">
                        {[...order.statusHistory].reverse().map((status, index) => (
                          <div key={index} className="d-flex align-items-center mb-2 p-2 rounded" style={{ backgroundColor: index === 0 ? 'rgba(25, 135, 84, 0.1)' : 'transparent' }}>
                            <div className="me-3">
                            ...
                            <div className="flex-grow-1">
                              <div className="fw-bold">
                                ...
                                {index === 0 && <Badge bg="success" className="ms-2">Current</Badge>}
                              </div>
                              <small className="text-muted">
