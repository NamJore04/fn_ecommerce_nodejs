...
const Products = () => {
  ...
  const loadProducts = async () => {
    try {
      ...
      // Merge pagination from response with total from response.data.total
      setPagination({
        ...
        <Col md={9}>
          ...
          {products.length === 0 ? (
            ...
            <>
              ...
              {!loading && products.length > 0 && pagination && pagination.totalPages > 0 && (
                <div className="d-flex justify-content-center mt-5">
                  <div className="d-flex flex-column align-items-center gap-3">
                    {/* Pagination Info */}
                    <div className="text-muted small">
                      Showing {((pagination.currentPage - 1) * 6) + 1} - {Math.min(pagination.currentPage * 6, pagination.total || 0)} of {pagination.total || 0} products
                    </div>
